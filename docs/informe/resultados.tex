...
\item \textbf{Heap}: 1.98 I/O por inserción para todo $N$, exactamente el costo teórico de 1R + 1W
  ...
  Es la inserción más barata y la más rápida (4.7\,s para 500\,000 registros).
...
y hash hacen las mismas 3 lecturas pero el hash es 3 veces más rápido: busca la clave en el bucket con
