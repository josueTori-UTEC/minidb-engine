...
\hypersetup{pdftitle={MiniDB: gestor de bases de datos relacional en disco},
  pdfauthor={Renzo Acervo, Josué Toribio, Lisseth Rondan}}

\begin{document}

%----------------------------- Portada estilo artículo -----------------------------
\thispagestyle{plain}
\begin{center}
{\LARGE MiniDB: gestor de bases de datos relacional en disco\par}
\vspace{1.4em}
{\large Renzo Acervo\textsuperscript{a}, Josué Toribio\textsuperscript{a}, Lisseth Rondan\textsuperscript{a}\par}
\vspace{1em}
{\small\itshape \textsuperscript{a}Departamento de Ciencia de la Computación, Universidad de Ingeniería y
Tecnología (UTEC), Lima, Perú\par}
\vspace{0.5em}
{\small Proyecto 1 (Entregable 1) --- Base de Datos II (CS2042) --- 2026-II --- Docente: Percy Lovon Ramos\par}
\end{center}
...
\vspace{0.6em}
\noindent\textit{Palabras clave:}\enspace Bases de datos, Memoria secundaria, Paginación, Heap File,
Sequential File, Árbol B$^+$, Extendible Hashing, Costo de I/O.\par
\vspace{0.3em}
...
\draw[arr] (m4) -- (o3);
\node[font=\scriptsize, align=right, anchor=east] at ($(o1.west)!0.5!(o2.west)-(0.5,0)$) {área de overflow (\code{.ovf}):\\cada página principal apunta a su\\cadena; los registros de la cadena\\caen en el rango de su página};
\end{tikzpicture}
...
\item \textbf{Hoja} (\code{BTREE\_LEAF}): pares ordenados $\langle K_i, RID_i\rangle$; en el header,
  \code{next\_page\_id} y \code{prev\_page\_id} hacen de \code{next\_leaf} y \code{prev\_leaf}.
