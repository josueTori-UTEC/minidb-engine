...
(16 bytes) y luego los campos propios de cada estructura: cabeza de la free-list y nº de registros
(Heap); capacidad, columna clave, fill factor y mínimo/máximo de la PK (Sequential); raíz, altura,
capacidades y nº de hojas (B$^+$); profundidad global y la tabla de segmentos del directorio (hash).
...
directorio del hash); las estadísticas (nº de registros, mínimo y máximo de la clave) viajan en esa
...
\code{GET /api/tables} & tablas con columnas y tipos, organización, nº de registros y de páginas, índices (tipo, columna, altura del B$^+$ o profundidad global del hash). \\
...
páginas), \textbf{editor SQL} con resaltado (CodeMirror~6), botón Ejecutar y atajo Ctrl+Enter,
...
\IfFileExists{figuras/frontend.png}{
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{frontend.png}
\caption{Cliente web: explorador, editor, resultados y plan/métricas de una consulta con \code{IndexScan}.}
\end{figure}}{}
...
(casos válidos y errores con posición); planner y ejecutor de punta a punta; y la API REST.
...
\bibitem{ramakrishnan} R. Ramakrishnan y J. Gehrke. \emph{Database Management Systems}, 3.ª ed. McGraw-Hill, 2003.
\bibitem{garcia} H. Garcia-Molina, J. D. Ullman y J. Widom. \emph{Database Systems: The Complete Book}, 2.ª ed. Pearson, 2008.
\bibitem{silberschatz} A. Silberschatz, H. F. Korth y S. Sudarshan. \emph{Database System Concepts}, 7.ª ed. McGraw-Hill, 2019.
